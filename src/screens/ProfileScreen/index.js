...
export default ProfileScreen = props => {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      >
        {content == 'accountType' && <AccountType hide={() => setModal(false)}/>}
      </Modal>
      <View style={styles.header}>
        ...
        <View style={styles.headerRight}>
          <Image source={{uri: 'http://s3.amazonaws.com/37assets/svn/765-default-avatar.png'}} style={styles.headerImage}></Image>
          <Icon name='create' style={styles.headerIcon}></Icon>
        </View>
      </View>
      {/* ========================================== */}
      <View style={styles.section}>
        <TouchableOpacity style={styles.row} onPress={() => {setModal(true); setContent('accountType')}}>
