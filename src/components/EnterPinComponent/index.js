        ...
        <View style={styles.topContainer}>
          ...
          <View style={styles.pinSection}>
            <View style={styles.singlePin}>
              {pin.length > 0 ? <View style={styles.filledPin} /> : <View />}
            </View>
            <View style={styles.singlePin}>
              {pin.length > 1 ? <View style={styles.filledPin} /> : <View />}
            </View>
            <View style={styles.singlePin}>
              {pin.length > 2 ? <View style={styles.filledPin} /> : <View />}
            </View>
            <View style={styles.singlePin}>
              {pin.length > 3 ? <View style={styles.filledPin} /> : <View />}
            </View>
            <View style={styles.singlePin}>
              {pin.length > 4 ? <View style={styles.filledPin} /> : <View />}
            </View>
            <View style={styles.singlePin}>
              {pin.length > 5 ? <View style={styles.filledPin} /> : <View />}
            </View>
          </View>
          <View>
            {isIncorrect ? (
